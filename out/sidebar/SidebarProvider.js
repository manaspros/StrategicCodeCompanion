...
class SidebarProvider {
    ...
    async analyzeWorkspace() {
        ...
        try {
            ...
            let chunks;
            try {
                const ingestion = new ingestion_1.CodeIngestion(workspaceRoot);
        ...
        try {
            ...
            vscode.window.withProgress({
                ...
                try {
                    ...
                    const llmProvider = llmProvider_1.LLMProviderFactory.createProvider(provider, apiKey);
...
SidebarProvider.viewType = 'strategic-code-companion.sidebar';
function getNonce() {
    let text = '';
