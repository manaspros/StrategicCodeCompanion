...
exports.DynamicAnalysisEngine = void 0;
class DynamicAnalysisEngine {
     ...
     */
    async analyzeCodebaseDynamically(analysis, codeChunks, refactoring, architecture) {
...
Focus on actionable insights that create competitive advantages and business value.`;
     ...
     */
    async generateLibrarySearchStrategy(analysis, codeChunks, dynamicAnalysis) {
...
Focus on search strategies that will find libraries creating unique competitive advantages.`;
     ...
     */
    async generateLearningPathStrategy(analysis, codeChunks, dynamicAnalysis) {
...
Focus on learning that creates unique competitive advantages and career differentiation.`;
    ...
    parseLearningStrategyResponse(response) {
        try {
            const jsonMatch = response.match(/\{[\s\S]*\}/);
            if (!jsonMatch)
                throw new Error('No JSON found in response');
    ...
    generateMinimalAnalysis(analysis) {
        return {
            functionalityGaps: [{
    ...
    generateBasicSearchStrategy(analysis) {
    ...
    generateBasicLearningStrategy(analysis) {
        return {
            learningGoals: [{
...
exports.DynamicAnalysisEngine = DynamicAnalysisEngine;
//# sourceMappingURL=DynamicAnalysisEngine.js.map